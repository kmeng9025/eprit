function epr_Contour2OpenSCAD_Plugs_18_mm(mod_name, fname, vectors, scale, UVShift, inverted_plug_wall)
...
if ~inverted
  ...
  str = [str,...
    ...
    '   translate([-Plug_OD/2-1 ,0,2]) ',endl,...
    '     cube([Notch_parameter, Notch_parameter, 4],true);',endl,...
    ' }',endl,...
    '',endl,...
    ' Plug_model();',endl,...
