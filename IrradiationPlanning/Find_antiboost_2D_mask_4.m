function [ Bev_masks_Hypoxia ] = Find_antiboost_2D_mask_4( Bev_masks_Hypoxia   )

%Varagin
% Bev_masks_Hypoxia is the output from Chuck's mask Bev program with added
% dilations to represent the margins used in this experiment.

%Bev_masks_Hypoxia.Subtract_Dilated_boost_map is the boost map dilated by
%the antiboost margin (standard is 0.6mm).

%Varaout
%The antiboost is stored at the end of this function in
%Bev_masks_Hypoxia.Antiboost_map 
