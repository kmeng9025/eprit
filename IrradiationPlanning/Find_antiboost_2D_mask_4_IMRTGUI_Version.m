function [ Bev_masks_Hypoxia ] = Find_antiboost_2D_mask_4_IMRTGUI_Version( Bev_masks_Hypoxia   )
...
Boost = Bev_masks_Hypoxia.Custom_subtract_Dilated_boost_map; 
Volume_Boost = numel(find(Bev_masks_Hypoxia.Custom_Dilated_boost_map));
...
Bev_masks_Hypoxia.Custom_Dilated_Antiboost_map = Antiboost;
