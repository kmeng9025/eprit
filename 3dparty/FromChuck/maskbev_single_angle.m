function [Bev_masks] = maskbev_single_angle(angles , CT_Tumor_mask, CT_hypoxia_mask, mask_out_boost  )
...
%         Bev_masks.(Angle_name).Antiboost_map = bmap;
         ...
         Bev_masks{ii}.Boost_bev_volume = numel(find(Bev_masks{ii}.Boost_map)) * (0.025^2) 
%  clf
