function [Bev_masks,  total_coverage ] = maskbev_with_3D_beams(angles , CT_Tumor_mask, CT_hypoxia_mask, mask_out_boost  )
...
total_coverage = zeros(size(CT_hypoxia_mask));
...
tic;
    ...
    Bev_masks{ii}.beam_coverage=(coverage);
