...
% Last Modified by GUIDE v2.5 10-Aug-2016 15:30:32
...
Tumor_mask = prj.images{EPRI_image_info{1}.ImageIdx}.slaves{Tumor_image_info{1}.SlaveIdx}.data;
cut_off = 0.5 ;
...
parfor ii = 1:length(Bev_masks)
        ...
        [ Bev_masks{ii} ] = Find_antiboost_2D_mask_3( Bev_masks{ii})
