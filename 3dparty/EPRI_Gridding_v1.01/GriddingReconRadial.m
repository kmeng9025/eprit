...
if ismac
    path(path, '/Users/borisepel/Dropbox/MATLAB/3dparty/EPRI_Gridding_v1.01/common');
    path(path, '/Users/borisepel/Dropbox/MATLAB/3dparty/EPRI_Gridding_v1.01/common/library');
else
    path(path, 'Z:\CenterMATLAB\3dparty\EPRI_Gridding_v1.01\common');
    path(path, 'Z:\CenterMATLAB\3dparty\EPRI_Gridding_v1.01\common\library');
end
...
if ismac
  ...
  s1=load('c:\Users\admin\Dropbox\MATLAB\DATA\IRESE2\prj_1892IRESE_0p75Gcm_ox63d24_tau1p8.mat');
end
proj = s1.kproj;
Nsample = size(proj,1);
centerIdx = Nsample/2;
