function pr=radon_uiuc(I, radon_pars)
...
parfor proj=1:projections
  I_rot = imrotate(permute(I,[2 1 3]),-phi(proj),'bilinear','crop');
  I_rot = ipermute(imrotate(permute(I_rot,[3 2 1]),-theta(proj),'bilinear','crop'),[3 2 1]);
